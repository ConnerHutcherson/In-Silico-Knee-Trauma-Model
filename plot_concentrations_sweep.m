function plot_concentrations_sweep(rows,cols,subs,sol,t_new)
% Function used to generate figures of model outputs with respect to sweeping 
% female hormone concentrations during menstrual cycle. (injury simulation starts on cycle days 1-30)
...
%     axes('Position',[0.2 0.2 0.7 0.7])
    plot(T./24,C(:,1).*1000,'LineWidth',2) 
...
% subplot(rows,cols,3);
%     axes('Position',[0.2 0.2 0.7 0.7])
    plot(T./24,C(:,5).*1000,'LineWidth',2)
...
% subplot(rows,cols,4);
%     axes('Position',[0.2 0.2 0.7 0.7])
    plot(T./24,C(:,6).*1000,'LineWidth',2)
...
% subplot(rows,cols,5);
%     axes('Position',[0.2 0.2 0.7 0.7])
    plot(T./24,C(:,7).*1000,'LineWidth',2)
...
%     subplot(rows,cols,9);
%     axes('Position',[0.2 0.2 0.7 0.7])
    plot(T./24,C(:,11).*1000,'LineWidth',2)
...
%     axes('Position',[0.2 0.2 0.7 0.7])
    plot(T./24,C(:,4).*1000,'LineWidth',2)
