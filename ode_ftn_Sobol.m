function [X] = ode_ftn_Sobol(t,x,Z,Ks)
...
f = all_feedback_functions_Sobol(IL1b,TNFa,IL10,TGFb,TGFb_del,estr,prog,testosterone,IL6);

% f_nom = all_feedback_functions(IL1b,TNFa,IL10,TGFb,TGFb_del,estr,prog,testosterone,IL6);
% f = all_feedback_mod(f_nom);
